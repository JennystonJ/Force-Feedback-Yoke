...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  HID_EPIN_SIZE, /*wMaxPacketSize: 5 Byte max (default 4 bytes)*/
  0x00,
...
//	    0xc0                           // END_COLLECTION
		...
		0x05, 0x01, // Usage Page ( Generic Desktop controls)
			...
			0xA1, 0x02, // Collection (Logical)
			 ...
			 0x75, 0x10, // Report Size (16) -> 16 bits (2 byte value)
			 0x95, 0x02, // Report Count (2) -> 2x = 4 bytes -> no bit stuffing
			 0x81, 0x02, // Input (Data,Var,Abs,...)
		   ...
		   0xC0, // End Collection =>  46 bytes
		         //  Report 4 bytes signed for XY and 1byte  unsigned for button info bit-0
